...
!function () {
	 ...
	 *	@function remove
	 *
	 *	@param {string} elementID The id of the html element that will be removed.
	 *
	...
	}; // End of cloth.retrieve.
	
	/**
	 *	@description Changes the value of an element with an id equal to elementID.
	 ...
	 *	@function value
	 *
	 *	@param {string} elememtID The id of the html element.
	 *
	 *	@param {string} elementValue The new value of the html element.
	 *
	 *	@tutorial cloth.value('exampleID','The is the new value');
	 */
