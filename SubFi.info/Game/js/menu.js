...
var menuState = {
	...
	menuScreen: function () {
		...
		var skillButton = game.add.button(width - 216, 28, 'skillButton',menuState.goToSkillScreen, this, 2, 1, 0);
		var inventoryButton = game.add.button(width - 288, 28, 'inventoryButton', menuState.goToInventoryScreen, this, 2, 1, 0);
		var characterButton = game.add.button(width - 360, 28, 'characterButton', menuState.goToCharacterScreen, this, 2, 1, 0);
		var tradeButton = game.add.button(width - 432, 28, 'tradeButton', menuState.goToTradeScreen, this, 2, 1, 0);
		var craftButton = game.add.button(width - 504, 28, 'craftButton', menuState.goToCraftScreen, this, 2, 1, 0);
		var rankButton = game.add.button(width - 576, 28, 'rankButton', menuState.goToRankScreen, this, 2, 1, 0);
	...
	goToTradeScreen: function(){
		game.debug.text("Trade Screen Hit",300,480)
	},
	/**
	 *
	 */
	goToCraftScreen: function(){
		game.debug.text("Craft Screen Hit",300,480)
	},
}